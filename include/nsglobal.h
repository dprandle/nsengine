...
#define DIR_SHADOWMAPXFB_SHADER_TYPESTRING "NSDirShadowXFBMapShader"
...
#define ANIM_SYS_UPDATE_PR 7.0f
#define CAM_SYS_UPDATE_PR 4.0f
#define BUILD_SYS_UPDATE_PR 5.0f
#define MOVE_SYS_UPDATE_PR 6.0f
#define PARTICLE_SYS_UPDATE_PR 8.0f
#define RENDER_SYS_UPDATE_PR 9.0f
#define SEL_SYS_UPDATE_PR 3.0f
#define INP_SYS_UPDATE_PR 1.0f
#define UI_SYS_UPDATE_PR 2.0f

// System draw priority
#define RENDER_SYS_DRAW_PR 1.0f
#define PARTICLE_SYS_DRAW_PR 2.0f
#define SEL_SYS_DRAW_PR 3.0f
#define UI_SYS_DRAW_PR 4.0f
#define NO_DRAW_PR 0.0f
