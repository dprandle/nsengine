...
void nswindow::show()
{
	if (m_visible == true || m_state == full_screen)
		return;
...
void nswindow::hide()
{
	if (m_visible == false || m_state == full_screen)
		return;
...
void nswindow::set_size(const ivec2 & sz)
{
	
}

void nswindow::swap_buffers()
{
	glfwSwapBuffers(m_window);	
}

void nswindow::set_position(const ivec2 & pos)
{
