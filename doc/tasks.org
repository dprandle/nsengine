...
* TODO Get basic text rendering working
...
** nstile_comp
* TODO Moving driver over to specialized class
** TODO Add events for resource creation and deletion
** TODO Move the gl_context stuff over to gl driver - no need for multiple plugin managers anymore
** TODO Create necessary management code for creating all the gl stuff outside of the resources themselves
